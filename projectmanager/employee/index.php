...
if (isset($_POST) && sizeof($_POST) != 0) {
    $resultset = MysqlConnection::fetchCustom("SELECT * FROM tbl_employee WHERE emailid = '$signinUsername' AND password = '$signinPassword'");
    if (sizeof($resultset) != 0) {
        print_r($resultset);
        $_SESSION["logindetails"] = $resultset;
