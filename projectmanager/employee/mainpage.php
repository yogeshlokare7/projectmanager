...
$empId = $_SESSION["logindetails"][0]["empId"];
$firstname = $_SESSION["logindetails"][0]["firstname"];
$middlename = $_SESSION["logindetails"][0]["middlename"];
$lastname = $_SESSION["logindetails"][0]["lastname"];
$emailid = $_SESSION["logindetails"][0]["emailid"];
$contactnumber = $_SESSION["logindetails"][0]["contactnumber"];
$altercontact = $_SESSION["logindetails"][0]["altercontact"];
$currentaddress = $_SESSION["logindetails"][0]["currentaddress"];
