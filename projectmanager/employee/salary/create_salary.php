                ...
                <div class="table-primary">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                        ...
                        <tbody>
                            <tr class="odd gradeX">
                                <td>Basic</td>
                                <td><input type="text" id="basic" onkeypress="return chkNumericKey(event)" name="basic" class="form-control" tabindex="2" onkeyup="calcuateGrossAmount()" autofocus="true" required></td>
                                <td>PF-Empl</td>
                                <td><input type="text" id="pfempl" onkeypress="return chkNumericKey(event)" name="pfempl" class="form-control" tabindex="10" onkeyup="calcuateDeductionAmount()" required></td>
                            </tr>
                            <tr class="odd gradeX">
                                <td>HRA</td>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><input type="text" id="transportallowance" onkeypress="return chkNumericKey(event)" name="transportallowance" class="form-control" tabindex="4" onkeyup="calcuateGrossAmount()" required></td>
                                <td>Professional Tax</td>
                                <td><input type="text" id="professionaltax" onkeypress="return chkNumericKey(event)" name="professionaltax" class="form-control" tabindex="12" onkeyup="calcuateDeductionAmount()" required></td>

                            </tr>
                            <tr class="odd gradeX">
                                <td>Medical Allowance</td>
                                <td><input type="text" id="medicalallowance" onkeypress="return chkNumericKey(event)" name="medicalallowance" class="form-control" tabindex="5" onkeyup="calcuateGrossAmount()" required></td>
                                <td>Income Tax</td>
                                <td><input type="text" id="incometax" name="incometax" onkeypress="return chkNumericKey(event)" class="form-control" tabindex="13" onkeyup="calcuateDeductionAmount()" required></td>
                            </tr>
                            <tr class="odd gradeX">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>Meal Vouchers</td>
                                <td><input type="text" id="mealvouchers" name="mealvouchers" onkeypress="return chkNumericKey(event)" class="form-control" tabindex="15" onkeyup="calcuateDeductionAmount()" required></td>
                            </tr>
                            <tr class="odd gradeX">
