...
$fetchCustom = "SELECT * FROM $tblname where isshortlisted = 'Y';";
                        ...
                        <tbody>
                            ...
                            foreach ($resultset as $key => $value) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="mainpage.php?pagename=addinterview_recruitment&recruitmentid=<?php echo $value["id"] ?>">Interview</a></td>
