...
if($_GET['del'] > 0){
    ...
    header("location:mainpage.php?pagename=create_leave");
}
?>
<div class="row">
    <div class="col-sm-12">
                        ...
                        <tbody>
                            ...
                            foreach ($resultset as $key => $value) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="mainpage.php?pagename=create_leave&del=<?php echo $value["id"] ?>" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-times"></i></a></td>
