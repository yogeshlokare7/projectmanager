                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group no-margin-hr">
                                ...
                                <input type="text" name="holidayname" autofocus="" placeholder="Enter Data Here" class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group no-margin-hr">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group no-margin-hr">
                                ...
                                <input type="text" name="noofday" autofocus="" placeholder="Enter Data Here" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>  
