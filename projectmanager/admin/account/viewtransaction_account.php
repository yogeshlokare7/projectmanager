                        ...
                        <tbody>
                            ...
                            foreach ($resultset as $key => $value) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="mainpage.php?pagename=viewtransaction_account&del=<?php echo $value["id"] ?>" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-times"></i></a></td>
